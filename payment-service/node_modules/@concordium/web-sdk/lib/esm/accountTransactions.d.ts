...
export declare class TokenUpdateHandler implements AccountTransactionHandler<TokenUpdatePayload, TokenUpdatePayloadJSON> {
...
export type AccountTransactionPayloadJSON = SimpleTransferPayloadJSON | SimpleTransferWithMemoPayloadJSON | DeployModulePayloadJSON | InitContractPayloadJSON | UpdateContractPayloadJSON | UpdateCredentialsPayload | RegisterDataPayloadJSON | ConfigureDelegationPayloadJSON | ConfigureBakerPayloadJSON | TokenUpdatePayloadJSON;
...
export declare function getAccountTransactionHandler(type: AccountTransactionType.TokenUpdate): TokenUpdateHandler;
