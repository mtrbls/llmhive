...
import { DelegationTargetType, } from './types.js';
...
export function serializeList(list, putSize, putMember) {
 ...
 * @returns big endian serialization of the input
 */
export function encodeInt16(value, useLittleEndian = false) {
 ...
 * @returns big endian serialization of the input
 */
export function encodeInt8(value) {
...
export function encodeWord16FromString(value, useLittleEndian = false) {
 ...
 */
export function packBufferWithWord32Length(buffer, useLittleEndian = false) {
 ...
 */
export function packBufferWithWord16Length(buffer, useLittleEndian = false) {
 ...
 */
export function packBufferWithWord8Length(buffer) {
 ...
 * @returns Buffer
 */
export function encodeHexString(s) {
 ...
 */
export const orUndefined = (fun) => (v) => v !== undefined ? fun(v) : undefined;
...
export const configureDelegationSerializationSpec = {
...
export const getSerializedConfigureDelegationBitmap = (payload) => encodeWord16(getPayloadBitmap(payload, Object.keys(configureDelegationSerializationSpec)));
export function serializeConfigureDelegationPayload(payload) {
...
export function serializeConfigureBakerPayload(payload) {
 ...
 */
export const makeSerializeOptional = (fun) => (value) => {
    if (value === undefined) {
        return encodeBool(false);
    }
    return Buffer.concat([encodeBool(true), fun(value)]);
};
export const makeSerializeList = (serialize) => (input) => {
