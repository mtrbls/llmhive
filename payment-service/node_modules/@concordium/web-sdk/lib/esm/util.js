 ...
 */
export function stringToInt(jsonStruct, keys) {
 ...
 */
export function countSignatures(accountSignatures) {
...
export async function streamToList(iterable) {
    const list = [];
 ...
 */
export const makeDynamicFunction = (fun) => (input) => fun(Array.isArray(input) ? input : [input]);
export function isDefined(v) {
    return v !== undefined;
}
export function toBuffer(s, encoding) {
