export function isTimestampAttribute(attribute) {
    return (attribute.type === 'date-time' &&
        typeof attribute.timestamp === 'string');
}
export const IDENTITY_SUBJECT_SCHEMA = {
    type: 'object',
    properties: {
        id: {
            title: 'id',
...
export function isAccountCredentialStatement(statement) {
    return statement.idQualifier.type === 'cred';
}
export function isVerifiableCredentialStatement(statement) {
    return statement.idQualifier.type === 'sci';
}
export function isVerifiableCredentialRequestStatement(statement) {
