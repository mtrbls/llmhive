...
import { ArInfo, AttributeKey, AttributesKeys, CredentialDeploymentDetails, CredentialDeploymentInfo, CredentialDeploymentPayload, CredentialPublicKeys, CryptographicParameters, HexString, IdentityInput, IdentityObjectV1, IpInfo, Network, UnsignedCdiWithRandomness, UnsignedCredentialDeploymentInformation, VerifyKey } from '../types.js';
 ...
 */
export declare function createCredentialDeploymentPayload(identity: IdentityInput, cryptographicParameters: CryptographicParameters, threshold: number, publicKeys: VerifyKey[], credentialIndex: number, revealedAttributes: AttributeKey[], expiry: TransactionExpiry.Type): CredentialDeploymentPayload;
/**
 ...
 */
export declare function createCredentialPayload(input: CredentialInput, expiry: TransactionExpiry.Type): CredentialDeploymentPayload;
/**
 ...
 */
export declare function createCredentialPayloadNoSeed(input: CredentialInputNoSeed, expiry: TransactionExpiry.Type): CredentialDeploymentPayload;
