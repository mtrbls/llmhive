...
import { AttributesKeys, } from '../types.js';
 ...
 */
export function createCredentialDeploymentPayload(identity, cryptographicParameters, threshold, publicKeys, credentialIndex, revealedAttributes, expiry) {
 ...
 */
export function createUnsignedCredentialForExistingAccount(identity, cryptographicParameters, threshold, publicKeys, credentialIndex, revealedAttributes, address) {
 ...
 */
export function buildSignedCredentialForExistingAccount(unsignedCredentialInfo, signatures) {
 ...
 */
export function getAccountAddress(credId) {
 ...
 */
export function createCredentialPayload(input, expiry) {
    ...
    const randomness = wallet
        ...
        .toString('hex');
    const attributeRandomness = mapRecord(filterRecord(AttributesKeys, (k) => isNaN(Number(k))), (x) => wallet
 ...
 */
export function createCredentialPayloadNoSeed(input, expiry) {
...
export async function signCredentialTransaction(credDeployment, signingKey) {
...
//# sourceMappingURL=credentialDeploymentTransactions.js.map