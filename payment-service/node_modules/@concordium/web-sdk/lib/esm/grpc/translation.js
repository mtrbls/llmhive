...
import { TransactionEventTag } from '../types.js';
...
export function unwrapValToHex(x) {
    return unwrapToHex(unwrap(x).value);
}
export function unwrapToBase58(address) {
...
function trAttKey(attributeKey) {
    return SDK.AttributesKeys[attributeKey];
}
...
function transCooldown(cooldown) {
    return {
...
function trTokenAccountInfo(token) {
    return {
...
export function nextAccountSequenceNumber(nasn) {
    return {
...
function trChainParametersV2(params) {
    ...
    return {
        ...
        finalizerRelativeStakeThreshold: trAmountFraction(params.finalizationCommitteeParameters?.finalizerRelativeStakeThreshold),
...
function trChainParametersV3(params) {
...
export function blockChainParameters(params) {
...
export function bakerPoolInfo(info) {
    return {
        ...
        delegatedCapitalCap: info.delegatedCapitalCap !== undefined ? CcdAmount.fromProto(info.delegatedCapitalCap) : undefined,
        ...
        currentPaydayStatus: info.currentPaydayInfo !== undefined ? transPaydayStatus(info.currentPaydayInfo) : undefined,
        allPoolTotalCapital: CcdAmount.fromProto(unwrap(info.allPoolTotalCapital)),
        isSuspended: info.isSuspended ?? false,
    };
}
export function passiveDelegationInfo(info) {
    return {
...
export function tokenomicsInfo(info) {
...
export function consensusInfo(ci) {
    const common = {
...
export function pendingUpdate(pendingUpdate) {
    return {
        ...
        case 'createPltUpdate':
            return {
                ...
                update: {
                    ...
                    initializationParameters: PLT.Cbor.fromProto(unwrap(payload.createPltUpdate.initializationParameters)),
                },
            };
        case undefined:
            return null;
...
function trOptionalAccessStructure(auths) {
    if (auths === undefined) {
        return undefined;
    }
    return {
...
function trCreatePltPayload(payload) {
    return {
...
export function blockItemSummary(summary) {
    const base = {
    ...
    switch (summary.details.oneofKind) {
        ...
        case 'accountCreation':
            return {
                ...
                ...base,
                credentialType: summary.details.accountCreation.credentialType === GRPC.CredentialType.INITIAL
                    ? 'initial'
                    : 'normal',
...
export function blockItemStatus(itemStatus) {
...
export function invokeInstanceResponse(invokeResponse) {
    switch (invokeResponse.result.oneofKind) {
        case 'failure':
            return {
                ...
                returnValue: invokeResponse.result.failure.returnValue === undefined
                    ? undefined
...
export function commonBlockInfo(blockInfo) {
    return {
        hash: BlockHash.fromProto(unwrap(blockInfo.hash)),
        height: unwrap(blockInfo.height?.value),
    };
}
export function instanceStateKVPair(state) {
    return {
...
export function blocksAtHeightResponse(blocks) {
    return blocks.blocks.map(BlockHash.fromProto);
}
export function blockInfo(blockInfo) {
    const common = {
...
export function delegatorInfo(delegatorInfo) {
    return {
...
export function branch(branchV2) {
    return {
...
export function electionInfo(electionInfo) {
    const common = {
...
export function nextUpdateSequenceNumbers(nextNums) {
    return {
...
export function trNodeInfo_Node(node) {
...
export function peerInfo(peerInfo) {
    let consensusInfo;
...
export function blockSpecialEvent(specialEvent) {
...
export function blockFinalizationSummary(finalizationSummary) {
...
export function blockCertificates(certs) {
    return {
...
export function quorumCertificate(cert) {
    return {
...
export function timeoutCertificate(cert) {
    return {
        round: unwrap(cert.round?.value),
...
export function epochFinalizationEntry(cert) {
    return {
...
export function finalizerRound(round) {
    return {
        round: unwrap(round.round?.value),
        finalizers: round.finalizers.map((x) => x.value),
    };
}
export function bakerRewardPeriodInfo(bakerRewardPeriod) {
    return {
...
export function bakerInfo(bakerInfo) {
    return {
        bakerId: unwrap(bakerInfo.bakerId?.value),
...
export function winningBaker(winningBaker) {
    return {
...
export function trTokenInfo(tokenInfo) {
    const state = {
...
export function BlocksAtHeightRequestToV2(request) {
