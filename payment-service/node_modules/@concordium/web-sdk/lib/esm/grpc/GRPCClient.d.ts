...
export declare class ConcordiumGRPCClient {
     ...
     */
    getNextAccountNonce(accountAddress: AccountAddress.Type): Promise<SDK.NextAccountNonce>;
    /**
     ...
     */
    getCryptographicParameters(blockHash?: BlockHash.Type): Promise<SDK.CryptographicParameters>;
    /**
     ...
     */
    getAccountInfo(accountIdentifier: SDK.AccountIdentifierInput, blockHash?: BlockHash.Type): Promise<SDK.AccountInfo>;
    /**
     ...
     */
    getConsensusStatus(): Promise<SDK.ConsensusStatus>;
    /**
     ...
     * @throws An error of type `RpcError` if not found in the block.
     */
    getModuleSource(moduleRef: ModuleReference.Type, blockHash?: BlockHash.Type): Promise<SDK.VersionedModuleSource>;
    /**
     ...
     */
    getEmbeddedSchema(moduleRef: ModuleReference.Type, blockHash?: BlockHash.Type): Promise<RawModuleSchema | undefined>;
    /**
     ...
     * @throws An error of type `RpcError` if not found in the block.
     */
    getInstanceInfo(contractAddress: ContractAddress.Type, blockHash?: BlockHash.Type): Promise<SDK.InstanceInfo>;
    /**
     ...
     */
    invokeContract(context: SDK.ContractContext, blockHash?: BlockHash.Type): Promise<SDK.InvokeContractResult>;
    /**
     ...
     */
    sendAccountTransaction(transaction: SDK.AccountTransaction, signature: SDK.AccountTransactionSignature): Promise<TransactionHash.Type>;
    /**
     ...
     */
    sendRawAccountTransaction(header: SDK.AccountTransactionHeader, energyAmount: Energy.Type, payload: Uint8Array, signature: SDK.AccountTransactionSignature): Promise<TransactionHash.Type>;
    /**
     ...
     * @returns The transaction hash
     */
    sendUpdateInstruction(updateInstructionTransaction: SDK.UpdateInstruction, signatures: Record<number, HexString>): Promise<TransactionHash.Type>;
    /**
     ...
     */
    getBlockChainParameters(blockHash?: BlockHash.Type): Promise<SDK.ChainParameters>;
    /**
     ...
     */
    getPoolInfo(bakerId: SDK.BakerId, blockHash?: BlockHash.Type): Promise<SDK.BakerPoolStatus>;
    /**
     ...
     */
    getPassiveDelegationInfo(blockHash?: BlockHash.Type): Promise<SDK.PassiveDelegationStatus>;
    /**
     ...
     */
    getTokenomicsInfo(blockHash?: BlockHash.Type): Promise<Upward<SDK.TokenomicsInfo>>;
    /**
     ...
     */
    waitForTransactionFinalization(transactionHash: TransactionHash.Type, timeoutTime?: number): Promise<SDK.BlockItemSummaryInBlock>;
    /**
     ...
     */
    getInstanceState(contractAddress: ContractAddress.Type, blockHash?: BlockHash.Type, abortSignal?: AbortSignal): AsyncIterable<SDK.InstanceStateKVPair>;
    /**
     ...
     */
    getBlocksAtHeight(blockHeightRequest: SDK.BlocksAtHeightRequest): Promise<BlockHash.Type[]>;
    /**
     ...
     */
    getBlockInfo(blockHash?: BlockHash.Type): Promise<SDK.BlockInfo>;
    /**
     ...
     */
    getPoolDelegators(baker: SDK.BakerId, blockHash?: BlockHash.Type, abortSignal?: AbortSignal): AsyncIterable<SDK.DelegatorInfo>;
    /**
     ...
     */
    getPoolDelegatorsRewardPeriod(baker: SDK.BakerId, blockHash?: BlockHash.Type, abortSignal?: AbortSignal): AsyncIterable<SDK.DelegatorRewardPeriodInfo>;
    /**
     ...
     * @returns a stream of DelegatorRewardPeriodInfo
     */
    getPassiveDelegatorsRewardPeriod(blockHash?: BlockHash.Type, abortSignal?: AbortSignal): AsyncIterable<SDK.DelegatorRewardPeriodInfo>;
    /**
     ...
     */
    getBranches(): Promise<SDK.Branch>;
    /**
     ...
     */
    getElectionInfo(blockHash?: BlockHash.Type): Promise<SDK.ElectionInfo>;
    /**
     ...
     */
    getBlockTransactionEvents(blockHash?: BlockHash.Type, abortSignal?: AbortSignal): AsyncIterable<Upward<BlockItemSummary>>;
    /**
     ...
     */
    getNextUpdateSequenceNumbers(blockHash?: BlockHash.Type): Promise<SDK.NextUpdateSequenceNumbers>;
    /**
     * Shut down the node.
     ...
     */
    peerConnect(ip: SDK.IpAddressString, port: number): Promise<void>;
    /**
     ...
     * @param port The port to connect to. Must be between 0 and 65535.
     */
    peerDisconnect(ip: SDK.IpAddressString, port: number): Promise<void>;
    /**
     ...
     */
    getBannedPeers(): Promise<SDK.IpAddressString[]>;
    /**
     * Ban the given peer.
     ...
     */
    banPeer(ip: SDK.IpAddressString): Promise<void>;
    /**
     ...
     */
    unbanPeer(ip: SDK.IpAddressString): Promise<void>;
    /**
     ...
     */
    getNodeInfo(): Promise<SDK.NodeInfo>;
    /**
     ...
     */
    getPeersInfo(): Promise<SDK.PeerInfo[]>;
    /**
     ...
     * node queried, in which case `null` is returned.
     */
    getBlockSpecialEvents(blockHash?: BlockHash.Type, abortSignal?: AbortSignal): AsyncIterable<Upward<SDK.BlockSpecialEvent>>;
    /**
     ...
     */
    getBlockFinalizationSummary(blockHash?: BlockHash.Type): Promise<SDK.BlockFinalizationSummary>;
    /**
     ...
     */
    getFinalizedBlocksFrom(startHeight: SDK.AbsoluteBlocksAtHeightRequest, abortSignal?: AbortSignal): AsyncIterable<SDK.FinalizedBlockInfo>;
    /**
     * Gets a stream of finalized blocks from specified `startHeight`.
     *
     * @param {bigint} [startHeight=0n] - An optional height to start streaming blocks from. Defaults to 0n.
     ...
     * @returns {AsyncIterable<SDK.FinalizedBlockInfo>} A stream of {@link SDK.FinalizedBlockInfo}.
     */
    getFinalizedBlocksFrom(startHeight: SDK.AbsoluteBlocksAtHeightRequest, endHeight?: SDK.AbsoluteBlocksAtHeightRequest): AsyncIterable<SDK.FinalizedBlockInfo>;
    /**
     ...
     */
    findEarliestFinalized<R>(predicate: (bi: SDK.FinalizedBlockInfo) => Promise<R | undefined>, from?: SDK.AbsoluteBlocksAtHeightRequest, to?: SDK.AbsoluteBlocksAtHeightRequest): Promise<R | undefined>;
    /**
     ...
     */
    findInstanceCreation(address: ContractAddress.Type, from?: SDK.AbsoluteBlocksAtHeightRequest, to?: SDK.AbsoluteBlocksAtHeightRequest): Promise<FindInstanceCreationReponse | undefined>;
    /**
     ...
     */
    findFirstFinalizedBlockNoLaterThan(time: Date, from?: SDK.AbsoluteBlocksAtHeightRequest, to?: SDK.AbsoluteBlocksAtHeightRequest): Promise<SDK.BlockInfo | undefined>;
    /**
     ...
     */
    getBakerEarliestWinTime(baker: SDK.BakerId): Promise<Timestamp.Type>;
    /**
     ...
     */
    getBlockCertificates(blockHash?: BlockHash.Type): Promise<SDK.BlockCertificates>;
    /**
     ...
     */
    getFirstBlockEpoch(epochRequest?: BlockHash.Type | SDK.RelativeEpochRequest): Promise<BlockHash.Type>;
     ...
     */
    healthCheck(): Promise<SDK.HealthCheckResponse>;
    /**
     ...
     */
    getTokenInfo(tokenId: PLT.TokenId.Type, blockHash?: BlockHash.Type): Promise<PLT.TokenInfo>;
    /**
 ...
 * @hidden
 */
export declare function getBlockHashInput(blockHash?: BlockHash.Type): GRPC.BlockHashInput;
/**
 * @hidden
 */
export declare function getAccountIdentifierInput(accountIdentifier: SDK.AccountIdentifierInput): GRPC.AccountIdentifierInput;
/**
 ...
 * @hidden
 */
export declare function getInvokerInput(invoker?: AccountAddress.Type | ContractAddress.Type): GRPC.Address | undefined;
