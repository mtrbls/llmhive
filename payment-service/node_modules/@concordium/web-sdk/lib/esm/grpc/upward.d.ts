...
export type Known<T> = T extends Unknown ? never : T extends Function ? T : T extends Map<infer K, infer V> ? Map<Known<K>, Known<V>> : T extends Set<infer S> ? Set<Known<S>> : T extends readonly (infer U)[] ? T extends readonly [any, ...any[]] ? {
    [I in keyof T]: Known<T[I]>;
} : Known<U>[] : T extends object ? {
 ...
 */
export declare function isKnown<T>(value: Upward<T>): value is T;
/**
 ...
 */
export declare function assertKnown<T>(value: Upward<T>, error: Error | string): value is T;
/**
 ...
 */
export declare function knownOrError<T>(value: Upward<T>, error: Error | string): T;
