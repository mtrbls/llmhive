...
import { encodeWord8, encodeWord64, makeSerializeList, makeSerializeOptional, packBufferWithWord8Length, packBufferWithWord16Length, } from '../serializationHelpers.js';
...
(function (CIS2) {
    ...
    let EventType;
    (function (EventType) {
        EventType[EventType["Transfer"] = 0] = "Transfer";
        EventType[EventType["Mint"] = 1] = "Mint";
        EventType[EventType["Burn"] = 2] = "Burn";
        EventType[EventType["UpdateOperatorOf"] = 3] = "UpdateOperatorOf";
        EventType[EventType["TokenMetadata"] = 4] = "TokenMetadata";
        EventType[EventType["Custom"] = 5] = "Custom";
    })(EventType = CIS2.EventType || (CIS2.EventType = {}));
    /**
    ...
    let ErrorType;
    (function (ErrorType) {
        ErrorType[ErrorType["InvalidTokenId"] = 0] = "InvalidTokenId";
        ErrorType[ErrorType["InsufficientFunds"] = 1] = "InsufficientFunds";
        ErrorType[ErrorType["Unauthorized"] = 2] = "Unauthorized";
        ErrorType[ErrorType["Custom"] = 3] = "Custom";
    })(ErrorType = CIS2.ErrorType || (CIS2.ErrorType = {}));
})(CIS2 || (CIS2 = {}));
...
export function serializeAccountAddress(address) {
 ...
 */
export function serializeContractAddress(address) {
...
function serializeAddress(address) {
    return Buffer.concat(ContractAddress.instanceOf(address)
 ...
 */
export function serializeReceiveHookName(hook) {
...
function serializeReceiver(receiver) {
    return Buffer.concat(AccountAddress.instanceOf(receiver)
 ...
 */
export function serializeCIS2MetadataUrl({ url, hash }) {
    const bUrl = packBufferWithWord16Length(Buffer.from(url, 'utf8'), true);
    const bHash = makeSerializeOptional((h) => Buffer.from(h, 'hex'))(hash);
 ...
 */
export function deserializeCIS2MetadataUrl(value) {
 ...
 */
export const deserializeCIS2TokenMetadataResponse = makeDeserializeListResponse(deserializeCIS2MetadataUrl);
 ...
 */
export function tokenAddressFromBase58(str) {
 ...
 */
export function tokenAddressToBase58(tokenAddress) {
 ...
 */
export function formatCIS2UpdateOperator(input) {
    return {
 ...
 */
export function formatCIS2Transfer(input) {
    const from = ContractAddress.instanceOf(input.from)
        ? {
            Contract: [
                {
...
function addressDeserializer(cursor) {
 ...
 */
export function deserializeCIS2Event(event) {
 ...
 */
export function deserializeCIS2EventsFromInvokationResult(result) {
 ...
 */
export function parseCIS2RejectionError(rejection) {
 ...
 * @returns {CIS2.NonCustomEvent[]} The deserialized events
 */
export function deserializeCIS2EventsFromSummary(summary) {
 ...
 */
function deserializeCIS2ContractTraceEvents(events) {
    const deserializedEvents = [];
