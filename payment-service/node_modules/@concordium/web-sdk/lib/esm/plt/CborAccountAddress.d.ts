...
declare const CCD_NETWORK_ID = 919;
...
declare class CborAccountAddress {
    #private;
    /** The address of the account holding the token. */
     ...
     * it is interpreted as a Concordium account.
     */
    coinInfo: typeof CCD_NETWORK_ID | undefined);
    toString(): string;
    /**
 ...
 */
export declare function fromAccountAddress(address: AccountAddress.Type): CborAccountAddress;
/**
 ...
 */
export declare function fromJSON(json: JSON): Type;
/**
 ...
 */
export declare function fromBase58(address: string): CborAccountAddress;
/**
 * Get a base58check string of the account address.
 * @param {CborAccountAddress} accountAddress The account address.
 */
export declare function toBase58(accountAddress: CborAccountAddress): string;
/**
 * Type predicate which checks if a value is an instance of {@linkcode Type}
 */
export declare function instanceOf(value: unknown): value is Type;
/**
 ...
 */
export declare function toCBOR(value: Type): Uint8Array;
/**
 ...
 */
export declare function fromCBORValue(value: unknown): Type;
/**
