...
(function (ErrorType) {
    ...
    ErrorType["EXCEEDS_MAX_DECIMALS"] = "EXCEEDS_MAX_DECIMALS";
    /** Error type indicating the token decimals were specified as a fractional number. */
    ErrorType["FRACTIONAL_DECIMALS"] = "FRACTIONAL_DECIMALS";
})(ErrorType || (ErrorType = {}));
/**
...
class TokenAmount {
    ...
    decimals) {
        ...
        _TokenAmount_nominal.set(this, true);
        if (value > MAX_U64) {
...
_TokenAmount_nominal = new WeakMap();
/**
 ...
 */
export function fromDecimal(amount, decimals) {
    let parsed;
 ...
 * @throws {Err} If the value/decimals exceeds the maximum allowed or is negative.
 */
export function create(value, decimals) {
 ...
 * @throws {Err} If the value/decimals exceeds the maximum allowed or is negative.
 */
export function fromProto(amount) {
 ...
 */
export function toProto(amount) {
    return {
        value: amount.value,
 ...
 */
export function fromCBORValue(decoded) {
