var _CborContractAddress_nominal;
...
(function (ErrorType) {
    ...
    ErrorType["EXCEEDS_MAX_VALUE"] = "EXCEEDS_MAX_VALUE";
    /** Error type indicating a contract index is negative. */
    ErrorType["NEGATIVE"] = "NEGATIVE";
})(ErrorType || (ErrorType = {}));
/**
...
class CborContractAddress {
    ...
    subindex) {
        ...
        _CborContractAddress_nominal.set(this, true);
...
_CborContractAddress_nominal = new WeakMap();
/**
 ...
 */
export const instanceOf = (v) => v instanceof CborContractAddress;
/**
 ...
 */
export function create(index, subindex) {
 ...
 */
export function fromContractAddress(address) {
 ...
 */
export function fromJSON(address) {
 ...
 */
export function toCBORValue(address) {
 ...
 */
export function toCBOR(address) {
...
function fromCBORValue(decoded) {
    ...
    const validateUint = (val) => typeof val === 'number' || typeof val === 'bigint';
    ...
    else if (validateUint(value))
        return new CborContractAddress(BigInt(value));
    else
        throw new Error('Invalid CBOR encoded contract address: expected uint value or tuple with 2 uint values.');
}
/**
...
//# sourceMappingURL=CborContractAddress.js.map