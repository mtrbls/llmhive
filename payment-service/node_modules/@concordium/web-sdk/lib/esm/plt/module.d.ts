import { CborAccountAddress, CreatePLTPayload, TokenAmount, TokenMetadataUrl } from './index.js';
/**
 ...
 */
export declare function createPltPayload(payload: Omit<CreatePLTPayload, 'initializationParameters'>, params: TokenInitializationParameters): CreatePLTPayload;
