 ...
 */
export function calculateEnergyCost(signatureCount, payloadSize, transactionSpecificCost) {
    return Energy.create(constantA * signatureCount +
 ...
 */
export function getEnergyCost(transactionType, payload, signatureCount = 1n) {
 ...
 */
export async function getContractUpdateEnergyCost(grpcClient, contractAddress, invoker, parameter, method, signatureCount, blockHash) {
    ...
    return calculateEnergyCost(signatureCount, getUpdatePayloadSize(parameter.buffer.length, method.toString().length), res.usedEnergy.value);
}
/**
