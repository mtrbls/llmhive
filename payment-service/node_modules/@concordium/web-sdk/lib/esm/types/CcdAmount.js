 ...
 */
export function fromMicroCcd(microCcdAmount) {
    ...
    if (microCcdAmount < 0n) {
        ...
        throw new Error('A micro CCD amount must be representable as an unsigned 64 bit integer but was: ' + microCcdAmount);
    }
 ...
 */
export function toMicroCcd(amount) {
 ...
 * @throws If the micro CCD passed is greater than what can be contained in a 64-bit integer
 */
export function ccdToMicroCcd(ccd) {
 ...
 * @throws If the micro CCD passed is greater than what can be contained in a 64-bit integer
 */
export function microCcdToCcd(microCcd) {
 ...
 */
export function toSchemaValue(amount) {
 ...
 */
export function fromSchemaValue(microCcdString) {
...
//# sourceMappingURL=CcdAmount.js.map