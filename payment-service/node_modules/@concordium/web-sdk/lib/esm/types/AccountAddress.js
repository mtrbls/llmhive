 ...
 */
export function toBuffer(accountAddress) {
 ...
 */
export function toSchemaValue(accountAddress) {
    return accountAddress.address;
}
/**
 ...
 * @returns {AccountAddress} The account address.
 */
export function fromSchemaValue(accountAddress) {
 ...
 */
export function isAlias(address, alias) {
    return (0 ===
        Buffer.from(address.decodedAddress).compare(alias.decodedAddress, 0, COMMON_BYTES_LENGTH, 0, COMMON_BYTES_LENGTH));
}
/**
 ...
 */
export function getAlias(address, counter) {
 ...
 * @returns {AccountAddress} The account address
 */
export function fromProto(accountAddress) {
 ...
 */
export function toProto(accountAddress) {
    return {
