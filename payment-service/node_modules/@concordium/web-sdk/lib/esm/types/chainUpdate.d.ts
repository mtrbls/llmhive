...
import type { ArInfo, AuthorizationsV0, AuthorizationsV1, Base58String, CommissionRates, ExchangeRate, FinalizationCommitteeParameters, GasRewardsV0, GasRewardsV1, HexString, IpInfo, MintDistribution, MintRate, TimeoutParameters, TransactionFeeDistribution, UpdatePublicKey, ValidatorScoreParameters } from '../types.js';
...
export type TransactionFeeDistributionUpdate = ChainUpdate<UpdateType.TransactionFeeDistribution, TransactionFeeDistribution>;
...
export type FinalizationCommitteeParametersUpdate = ChainUpdate<UpdateType.FinalizationCommitteeParameters, FinalizationCommitteeParameters>;
...
export type CommonUpdate = MicroGtuPerEuroUpdate | EuroPerEnergyUpdate | TransactionFeeDistributionUpdate | FoundationAccountUpdate | MintDistributionUpdate | ProtocolUpdate | GasRewardsV0Update | BakerStakeThresholdUpdate | ElectionDifficultyUpdate | AddAnonymityRevokerUpdate | AddIdentityProviderUpdate | CooldownParametersUpdate | PoolParametersUpdate | TimeParametersUpdate | GasRewardsV1Update | TimeoutParametersUpdate | MinBlockTimeUpdate | BlockEnergyLimitUpdate | FinalizationCommitteeParametersUpdate | PendingValidatorScoreUpdate | CreatePLTUpdate;
...
export declare enum KeyUpdateEntryStatus {
    Added = 0,
    Removed = 1,
    Unchanged = 2
}
...
export declare enum HigherLevelKeyUpdateType {
...
export declare enum AuthorizationKeysUpdateType {
