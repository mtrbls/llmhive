 ...
 * @deprecated
 */
export declare const JSON_DISCRIMINATOR = TypedJsonDiscriminator.TransactionExpiry;
export type Serializable = string;
/**
 * Representation of a transaction expiry date.
 */
declare class TransactionExpiry {
    #private;
    /** Internal representation of expiry. Seconds since unix epoch */
    readonly expiryEpochSeconds: bigint;
    constructor(
    /** Internal representation of expiry. Seconds since unix epoch */
 ...
 */
export declare function instanceOf(value: unknown): value is TransactionExpiry;
/**
 ...
 */
export declare function fromEpochSeconds(seconds: bigint | number): TransactionExpiry;
/**
 ...
 */
export declare function fromDate(expiry: Date): TransactionExpiry;
/**
 * Convert a TransactionExpiry into a Date object.
 * @param {TransactionExpiry} expiry A TransactionExpiry to convert.
 * @returns {Date} The date object.
 */
export declare function toDate(expiry: TransactionExpiry): Date;
/**
 ...
 * @returns {TransactionExpiry} The transaction expiry.
 */
export declare function futureMinutes(minutes: number): TransactionExpiry;
/**
 ...
 */
export declare function fromProto(expiry: Proto.TransactionTime): TransactionExpiry;
/**
 ...
 */
export declare function toProto(expiry: TransactionExpiry): Proto.TransactionTime;
/**
 ...
 */
export declare function toTypedJSON(value: TransactionExpiry): TypedJson<Serializable>;
/**
 ...
 */
export declare const fromTypedJSON: ({ ["@type"]: type, value }: TypedJson<string>) => string | TransactionExpiry;
export {};
