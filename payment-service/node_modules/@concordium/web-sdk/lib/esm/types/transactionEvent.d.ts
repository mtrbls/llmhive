...
import type { Address, BakerId, DelegatorId, EventDelegationTarget, HexString, ModuleRef, OpenStatusText, ReleaseSchedule } from '../types.js';
...
export declare enum TransactionEventTag {
...
export type TransactionEvent = AccountTransferredEvent | MemoEvent | TransferredWithScheduleEvent | AccountCreatedEvent | AmountAddedByDecryptionEvent | EncryptedSelfAmountAddedEvent | NewEncryptedAmountEvent | EncryptedAmountsRemovedEvent | DataRegisteredEvent | ContractInitializedEvent | ModuleDeployedEvent | CredentialDeployedEvent | CredentialKeysUpdatedEvent | CredentialsUpdatedEvent | UpdateEnqueuedEvent | DelegationEvent | BakerEvent | TokenEvent;
...
export type BakerEvent = BakerSetTransactionFeeCommissionEvent | BakerSetBakingRewardCommissionEvent | BakerSetFinalizationRewardCommissionEvent | BakerSetMetadataURLEvent | BakerSetOpenStatusEvent | BakerSetRestakeEarningsEvent | BakerStakeChangedEvent | BakerAddedEvent | BakerRemovedEvent | BakerKeysUpdatedEvent | BakerDelegationRemovedEvent | BakerSuspendedEvent | BakerResumedEvent;
export type DelegationEvent = DelegatorEvent | DelegationSetDelegationTargetEvent | DelegationSetRestakeEarningsEvent | DelegationStakeChangedEvent | DelegationBakerRemovedEvent;
