var _TransactionExpiry_nominal;
...
class TransactionExpiry {
    ...
    expiryEpochSeconds) {
        ...
        _TransactionExpiry_nominal.set(this, true);
    }
    /**
...
_TransactionExpiry_nominal = new WeakMap();
/**
 ...
 */
export function fromDate(expiry) {
 ...
 */
export function fromProto(expiry) {
 ...
 */
export function toProto(expiry) {
    return {
...
//# sourceMappingURL=TransactionExpiry.js.map