 ...
 * @deprecated
 */
export declare const JSON_DISCRIMINATOR = TypedJsonDiscriminator.CcdAmount;
/**
 * @deprecated
 */
 ...
 */
export declare function fromJSON(json: string): CcdAmount;
/**
 * Representation of a CCD amount.
 * The base unit of CCD is micro CCD, which is the representation
 * used on chain.
 ...
 */
export declare function instanceOf(value: unknown): value is CcdAmount;
/**
 ...
 */
export declare function fromMicroCcd(microCcdAmount: BigSource | bigint): CcdAmount;
/**
 * Create a value representing zero CCD.
 * @returns {CcdAmount} A zero amount of CCD
 */
export declare function zero(): CcdAmount;
/**
 ...
 */
export declare function fromCcd(ccd: BigSource | bigint): CcdAmount;
/**
 * Returns the amount of micro CCD as a Big.
 * @param {CcdAmount} amount The CCD amount.
 * @returns {Big} The amount in micro CCD.
 */
export declare function toMicroCcd(amount: CcdAmount): Big;
/**
 * Returns the amount of CCD as a Big.
 * @param {CcdAmount} amount The CCD amount.
 * @returns The amount of CCD as a Big
 */
export declare function toCcd(amount: CcdAmount): Big;
/**
 ...
 * @throws If the micro CCD passed is greater than what can be contained in a 64-bit integer
 */
export declare function ccdToMicroCcd(ccd: BigSource | bigint): Big;
/**
 ...
 * @throws If the micro CCD passed is greater than what can be contained in a 64-bit integer
 */
export declare function microCcdToCcd(microCcd: BigSource | bigint): Big;
/**
 ...
 */
export declare function toSchemaValue(amount: CcdAmount): SchemaValue;
/**
 ...
 */
export declare function fromSchemaValue(microCcdString: SchemaValue): CcdAmount;
/**
 ...
 */
export declare function fromProto(amount: Proto.Amount): CcdAmount;
/**
 * Convert an amount of CCD into its protobuf encoding.
 * @param {CcdAmount} amount The CCD amount.
 * @returns {Proto.Amount} The protobuf encoding.
 */
export declare function toProto(amount: CcdAmount): Proto.Amount;
/**
 ...
 */
export declare function toTypedJSON(value: CcdAmount): TypedJson<Serializable>;
/**
 ...
 */
export declare const fromTypedJSON: ({ ["@type"]: type, value }: TypedJson<string>) => string | CcdAmount;
export {};
