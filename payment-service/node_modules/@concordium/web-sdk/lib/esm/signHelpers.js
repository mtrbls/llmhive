...
function validateSimpleWallet(wallet) {
    ...
    if (typeof wallet.credentials !== 'object') {
        throw Error('Expected field "credentials" to be of type "object" but was of type "' + typeof wallet.credentials + '"');
    }
 ...
 */
export function parseSimpleWallet(walletString) {
