...
import { AttributeKeyString, AttributesKeys, IdDocType } from '../types.js';
/**
 ...
 */
export function getPastDate(yearsAgo, daysOffset = 0) {
    const date = new Date();
 ...
 */
export function verifyIdstatement(statements) {
...
//# sourceMappingURL=idProofs.js.map