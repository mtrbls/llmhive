 ...
 */
export const checkParameterLength = (buffer) => {
 ...
 */
export const isEqualContractAddress = (a) => (b) => a.index === b.index && a.subindex === b.subindex;
/** Check that every character is an Ascii alpha, numeric or punctuation. */
export function isAsciiAlphaNumericPunctuation(string) {
...
export function isInitName(string) {
...
export function getContractNameFromInit(initName) {
    return initName.substring(5);
}
/** Check if a string is a valid smart contract receive name. */
export function isReceiveName(string) {
...
export function getNamesFromReceive(receiveName) {
 ...
 */
export function getUpdatePayloadSize(parameterSize, receiveNameLength) {
