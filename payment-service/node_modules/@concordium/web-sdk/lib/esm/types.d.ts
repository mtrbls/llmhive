...
export declare enum TransactionSummaryType {
...
export type ChainParametersV0 = ChainParametersCommon & CooldownParametersV0 & PoolParametersV0 & {
    version: 0;
...
export type ChainParametersV1 = ChainParametersCommon & CooldownParametersV1 & TimeParametersV1 & PoolParametersV1 & {
    version: 1;
    /** The election difficulty for consensus lottery */
    electionDifficulty: number;
    /** The election difficulty for consensus lottery */
...
export type ChainParametersV2 = ChainParametersCommon & CooldownParametersV1 & TimeParametersV1 & PoolParametersV1 & FinalizationCommitteeParameters & TimeoutParameters & ConsensusParameters & {
    version: 2;
    /** The election difficulty for consensus lottery */
...
type BakerPoolPendingChangeWrapper<T extends keyof typeof BakerPoolPendingChangeType, S extends Record<string, any>> = S & {
    pendingChangeType: T;
};
...
export type BakerPoolPendingChangeReduceBakerCapital = BakerPoolPendingChangeWrapper<BakerPoolPendingChangeType.ReduceBakerCapital, BakerPoolPendingChangeReduceBakerCapitalDetails>;
export interface BakerPoolPendingChangeRemovePoolDetails {
    effectiveTime: Date;
}
export type BakerPoolPendingChangeRemovePool = BakerPoolPendingChangeWrapper<BakerPoolPendingChangeType.RemovePool, BakerPoolPendingChangeRemovePoolDetails>;
export type BakerPoolPendingChangeNoChange = BakerPoolPendingChangeWrapper<BakerPoolPendingChangeType.NoChange, {}>;
export type BakerPoolPendingChange = BakerPoolPendingChangeReduceBakerCapital | BakerPoolPendingChangeRemovePool | BakerPoolPendingChangeNoChange;
 ...
 */
export type PassiveDelegationStatus = PoolStatusWrapper<PoolStatusType.PassiveDelegation, PassiveDelegationStatusDetails>;
...
export declare enum AccountInfoType {
    Simple = "simple",
    Baker = "baker",
    Delegator = "delegator",
    Unknown = "unknown"
...
export type AccountTransactionPayload = SimpleTransferPayload | SimpleTransferWithMemoPayload | RegisterDataPayload | DeployModulePayload | InitContractPayload | UpdateContractPayload | UpdateCredentialsPayload | ConfigureBakerPayload | ConfigureDelegationPayload | TokenUpdatePayload;
...
} | SmartContractTypeValues[] | number | bigint | string | boolean;
/**
 ...
 */
export declare enum CooldownStatus {
    /**
