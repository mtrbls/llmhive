...
import { AccountTransaction, AccountTransactionSignature, CredentialDeploymentDetails, CredentialDeploymentInfo, UnsignedCredentialDeploymentInformation } from './types.js';
 ...
 */
export declare function serializeAccountTransactionPayload(accountTransaction: Omit<AccountTransaction, 'header'>): Buffer;
/**
 ...
 */
export declare function getCredentialForExistingAccountSignDigest(unsignedCredentialDeploymentInfo: UnsignedCredentialDeploymentInformation, address: AccountAddress.Type): Buffer;
/**
