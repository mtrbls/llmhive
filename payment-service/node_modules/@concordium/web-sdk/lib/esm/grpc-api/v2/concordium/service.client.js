...
export class QueriesClient {
     ...
     */
    getScheduledReleaseAccounts(input, options) {
     ...
     */
    getCooldownAccounts(input, options) {
     ...
     */
    getPreCooldownAccounts(input, options) {
     ...
     */
    getPrePreCooldownAccounts(input, options) {
     ...
     */
    getConsensusDetailedStatus(input, options) {
